...
SELECT
    ...
    SUM(payment.amount) AS total_rental
FROM
	customer
LEFT JOIN rental
...
SELECT
    ...
    WHEN actor_award.awards IN('Emmy, Oscar', 'Oscar, Tony', 'Emmy, Tony', 'Oscar, Emmy', 'Tony, Emmy', 'Tony, Oscar') THEN 2
    ELSE 1
